...
const FOG_BASE_START: f32 = 46.0; // was 40 — pushed back out with the atmospherics pass carrying the near haze
const FOG_BASE_END: f32 = 126.0; // was 112 — 2026-07: forward visibility read short with both fogs stacked
